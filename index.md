...
propuesta:
  ...
  promesa: Que el proyecto salga perfecto depende de quien lo ejecuta. Lo que yo
    te garantizo es que sepas en todo momento cómo va tu inversión y puedas
  ...
  items:
    - tag: Punto de entrada
      ...
      text: "Una radiografía completa de tu proyecto: qué se está construyendo, cómo
        se está construyendo y qué te va a costar si todo sigue igual. Y si aún
        estás en la casilla de salida, qué necesitas construir y cómo."
      incluye:
      ...
      garantia: Te proporciono una hoja de ruta clara y accionable, o te devuelvo el
        importe.
    ...
    - tag: Continuidad
      ...
      incluye:
        ...
        - item: Asesoramiento continuo sobre decisiones técnicas que impactan en el
            negocio.
...
proceso:
  ...
  pasos:
    ...
    - title: Decisión
      text: "Decides tú: aplicar la hoja de ruta por tu cuenta o que yo continúe
...
independencia:
  ...
  text: El valor entero de este servicio es la objetividad. Mi opinión te sirve
    precisamente porque gano lo mismo tanto si mantienes a tu proveedor como si
    lo cambias.
  bullets:
    ...
    - item: Cualquier otra actividad profesional queda fuera, por una política de
        independencia estricta, publicada y verificable.
...
sobre:
  ...
  parrafos:
    - texto: He liderado tecnología en entornos donde un error se paga en dinero, en
        regulación y en clientes. Mis 20 años de experiencia en tecnología me
        enseñaron a mirar un proyecto y ver dónde va a complicarse antes de que
        lo haga.
  ...
  items:
    ...
    - pregunta: ¿Vas a sustituir a mi equipo o a mi proveedor?
      respuesta: "Lo habitual es justo lo contrario: el equipo rinde mejor cuando las
        ...
        técnicos. Solo lo plantearé si el diagnóstico demuestra que es la única
        salida — y aun así, la decisión es tuya."
    - pregunta: ¿Y si mi proyecto está aún por empezar?
      respuesta: Es el mejor momento posible. Decidir bien qué construir primero y con
        qué perfil ejecutarlo es donde más dinero se ahorra, porque todo el
        presupuesto sigue intacto.
    - pregunta: ¿Qué necesitas de mi equipo?
      respuesta: "Acceso de lectura al repositorio y a la herramienta de gestión, y un
        par de conversaciones cortas. Trabajo con lo que ya generan, sin
        pedirles informes extra: parte del diagnóstico es precisamente ver cómo
        trabajan hoy."
